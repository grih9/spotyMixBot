...
def generate_playlist_feature(complete_feature_set, playlist_df, weight_factor):
    ...
    Parameters: 
        ...
        weight_factor (float): float value that represents the recency bias. The larger the recency bias, the most
        priority recent songs get. Value should be close to 1.
